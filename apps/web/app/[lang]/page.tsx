    ...
    return (
        <main className="min-h-screen flex flex-col bg-background text-foreground selection:bg-primary selection:text-primary-foreground">
                        ...
                        {[
                            {
                                ...
                                ...dict.features.items[0]
                            },
                            {
                                icon: <Share2 className="w-8 h-8" />,
                                ...dict.features.items[1]
                            },
                            {
                                icon: <Sparkles className="w-8 h-8" />,
                                ...dict.features.items[2]
                            }
                        ].map((feature: any, i) => (
                            <div
                                key={i}
                                className="p-8 rounded-2xl bg-background border hover:shadow-xl hover:shadow-primary/5 transition-all duration-300"
                            >
            ...
            <section className="py-24 border-y">
                <div className="container mx-auto px-6 text-center">
                    <h2 className="text-2xl font-bold mb-12 opacity-50">
                        {dict.trust.title}
                    </h2>
            ...
            <footer className="py-12 border-t">
                <div className="container mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-6">
                    <div className="flex items-center gap-2">
                        ...
                        <span className="font-bold opacity-50">Mohajon</span>
                    </div>
                    <p className="text-sm text-muted-foreground">
                        © {new Date().getFullYear()} Mohajon.{" "}
