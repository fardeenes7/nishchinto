            ...
            <SidebarInset>
                {isSuspended && (
                    <div className="bg-destructive text-destructive-foreground px-4 py-2 text-center text-sm font-medium flex items-center justify-center gap-2">
                        ...
                        <span>
                            {subscription.suspension_banner ||
                                "⚠️ Service Paused — Payment Issue"}
                        </span>
                        <Button
                            variant="link"
                            size="sm"
                            className="text-destructive-foreground underline p-0 h-auto"
                            asChild
                        >
                ...
                {isComplianceLocked && (
                    <div className="bg-warning text-warning-foreground px-4 py-2 text-center text-sm font-medium flex items-center justify-center gap-2">
                        ...
                        <Button
                            variant="link"
                            size="sm"
                            className="text-warning-foreground underline p-0 h-auto"
                            asChild
                        >
          ...
          <Breadcrumb>
            <BreadcrumbList>
              <BreadcrumbItem>
                ...
                <main className="flex flex-1 flex-col gap-4 p-6 [&:has(.full-screen)]:p-0">
                    {children}
                </main>
            </SidebarInset>
        </SidebarProvider>
