    ...
    return (
        <div className="full-screen flex flex-col md:flex-row h-screen">
            ...
            <div className="w-full md:w-80 flex flex-col overflow-hidden border-r">
                <div className="h-header p-4 flex items-center border-b font-bold">
                    Inbox
                </div>
                <ScrollArea className="h-[calc(100vh-var(--spacing-header))] flex-1 overflow-y-auto">
                    {[1, 2, 3].map((i) => (
                        <div
                            key={i}
                        ...
                        >
                            ...
                            <div className="flex items-center justify-between">
                                ...
                                {i === 1 ? (
                                    <Badge
                                        variant="outline"
                                        className="text-[10px] h-4 px-1 py-0 border-blue-500 text-blue-500"
                                    >
                                        Human Active
                                    </Badge>
                                ) : (
                ...
                <div className="flex-1 p-4 overflow-y-auto flex flex-col gap-4 bg-muted/20">
                    ...
                    <div className="flex flex-col gap-1 items-end">
                        <div className="bg-primary text-primary-foreground px-4 py-2 rounded-2xl rounded-tr-none max-w-[80%] text-sm">
                            Hello! I'd be happy to help. Can you please provide
                            your order ID?
                        </div>
                    ...
                    <div className="flex flex-col gap-1 items-end">
                        <div className="bg-blue-600 text-white px-4 py-2 rounded-2xl rounded-tr-none max-w-[80%] text-sm">
                            Hi there, human agent here. I'm looking into this
                            for you right now.
                        </div>
                        <span className="text-[10px] text-muted-foreground mr-1 flex items-center gap-1">
